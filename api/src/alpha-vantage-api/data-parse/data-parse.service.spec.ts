...
describe('DataParseService', () => {
  ...
  it('should return a QuoteDTO object with the correct values', () => {
    const input = {
      'Global Quote': {
        '01. symbol': 'GOOG',
        '02. open': '124.4700',
    ...
    const output = service.parseGlobalQuote(input);

    expect(output).toEqual(expectedOutput);
  });

  it('should return a TimeSeriesDailyResponseDTO object with the correct values', () => {
    const input = {
      'Meta Data': {
    ...
    const output = service.parseTimeSeriesDaily(
      input,
      new DateInterval(
